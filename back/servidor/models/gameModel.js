...
const WORDS = [
  'Dragon',   'Shadow',  'Ninja',   'Castle',  'Robot',
  'Pirate',   'Laser',   'Ghost',   'Knight',  'Storm',
  'Phoenix',  'Snake',   'Tiger',   'Moon',    'Star',
  'Alien',    'Magic',   'King',    'Queen',   'Samurai',
  'Zombie',   'Spy',     'Cyber',   'Wolf',    'Rocket',
  'Virus',    'Cipher',  'Code',    'Hack',    'Matrix',
  'Falcon',   'Thunder', 'Viper',   'Phantom', 'Eclipse',
  'Nebula',   'Orbit',   'Pulse',   'Surge',   'Byte',
  'Vector',   'Circuit', 'Debug',   'Server',  'Glitch',
  'Portal',   'Nexus',   'Rogue',   'Stealth', 'Flare',
  'Dagger',   'Shield',  'Vault',   'Frost',   'Blaze',
  'Delta',    'Sigma',   'Alpha',   'Omega',   'Apex',
  'Raven',    'Cobra',   'Panther', 'Hydra',   'Specter',
  'Wraith',   'Blade',   'Ember',   'Spark',   'Flux',
  'Mirage',   'Quasar',  'Rift',    'Shard',   'Toxin',
  'Venom',    'Zenith',  'Abyss',   'Bastion', 'Phantom',
];
